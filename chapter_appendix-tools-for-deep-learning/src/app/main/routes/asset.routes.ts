...
/**
 * A class that initializes and manages the asset model entry points.
 */
export default class AssetRoute {
    ...
    /**
     * An instance of the AssetController class for managing Asset routes.
     * @private
     */
    private _controller:AssetController;
    /**
     * Creates an instance of the AssetRoute class and initializes the main router and API routes.
     */
    constructor() {
        this.routes = Router();
        this._controller = new AssetController();
        this.initializeRoutes();
    }
    /**
     * Initializes the Asset routes by mounting the API routes.
     */
